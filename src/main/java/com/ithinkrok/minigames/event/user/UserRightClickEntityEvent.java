 ...
 */
public class UserRightClickEntityEvent<U extends User> extends UserInteractEvent<U> {

    private PlayerInteractEntityEvent event;

    public UserRightClickEntityEvent(U user, PlayerInteractEntityEvent event) {
        super(user);
        this.event = event;
    }
