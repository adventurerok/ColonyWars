...
public class EntityUtils {
     ...
     */
    public static <U extends User> U getRepresentingUser(UserResolver<U> resolver, Entity entity) {
    ...
    public static <U extends User> U getActualUser(UserResolver<U> resolver, Entity entity) {
        if (entity instanceof Player) return getUserFromPlayer(resolver, (Player) entity);
    ...
    private static <U extends User> U getUserFromPlayer(UserResolver<U> resolver, Player player) {
