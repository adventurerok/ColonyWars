...
import com.ithinkrok.oldmccw.listener.WarsGameListener;
...
import com.ithinkrok.oldmccw.util.io.DirectoryUtils;
...
public class GameInstance {
    ...
    private void startGame() {
        ...
        World map = Bukkit.createWorld(new WorldCreator(plugin.getPlayingWorldName()).environment(environment));
